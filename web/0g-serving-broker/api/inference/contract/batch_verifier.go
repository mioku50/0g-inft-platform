...
var BatchVerifierMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"GroupOrder\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"pure\",\"type\":\"function\"}]",
}
...
// GroupOrder is a free data retrieval call binding the contract method 0x2bed9cb4.
//
// Solidity: function GroupOrder() pure returns(uint256)
func (_BatchVerifier *BatchVerifierCaller) GroupOrder(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _BatchVerifier.contract.Call(opts, &out, "GroupOrder")
...
//
// Solidity: function GroupOrder() pure returns(uint256)
func (_BatchVerifier *BatchVerifierSession) GroupOrder() (*big.Int, error) {
	return _BatchVerifier.Contract.GroupOrder(&_BatchVerifier.CallOpts)
}

// GroupOrder is a free data retrieval call binding the contract method 0x2bed9cb4.
//
// Solidity: function GroupOrder() pure returns(uint256)
func (_BatchVerifier *BatchVerifierCallerSession) GroupOrder() (*big.Int, error) {
	return _BatchVerifier.Contract.GroupOrder(&_BatchVerifier.CallOpts)
}
