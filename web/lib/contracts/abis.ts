...
// Agent Model Registry ABI - For fine-tuning lifecycle management
export const AGENT_MODEL_REGISTRY_ABI = [
  {
    "inputs": [],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct AgentModelRegistry.ModelVersion[]",
        "name": "candidates",
        "type": "tuple[]"
      }
    ],
